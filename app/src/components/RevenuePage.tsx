...
const RevenuePage: React.FC = () => {
  ...
  }, [videos, ipRegistrations, isWalletConnected, isLoadingYouTubeVideos]);
  ...
  const chartData = [
    { name: 'YouTube Revenue', value: overallRevenueData.youtubeRevenue, fill: '#fe002c' }, // creator-primary
    { name: 'Story Protocol Royalties', value: overallRevenueData.storyProtocolRoyalties, fill: '#3B82F6' }, // protocol-blue
  ];
              ...
              <tbody className="bg-creator-surface divide-y divide-gray-700">
                {sortedVideoRevenueDetails.map((video) => (
                  <tr key={video.id}>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-right text-creator-primary">${video.youtubeRevenue.toFixed(2)}</td>
