  ...
  const getStatusIndicator = () => {
    switch (registrationStatus) {
      case IPRegistrationStatus.REGISTERED:
        return <div className="flex items-center text-protocol-blue"><CheckCircleIcon className="w-5 h-5 mr-1" /> Registered</div>;
        ...
        <div className="mt-auto">
          ...
          {registrationStatus === IPRegistrationStatus.REGISTERED && onViewDetails && ipRegistration && (
            <button
              ...
              className="w-full bg-gray-700 hover:bg-gray-600 text-creator-text-primary font-semibold py-2 px-4 rounded-md transition duration-150 ease-in-out text-sm"
            >
              View IP Details
            </button>
          )}
