      ...
      <div>
        ...
        <div className="space-y-3 mb-4">
          {LICENSE_OPTIONS.map((option) => {
            ...
            if (isSelected) {
              if (isDefaultOption) {
                selectionClasses = 'bg-green-500/20 border-green-500 ring-2 ring-green-500'; // Green-themed for default selected
              } else {
                selectionClasses = 'bg-protocol-blue/20 border-protocol-blue ring-2 ring-protocol-blue'; // Blue-themed for other selected
              }
            }
              ...
              >
                <div className="flex items-center">
                  <input
                    ...
                    className={`form-radio h-4 w-4 mr-3 ${isDefaultOption && isSelected ? 'text-green-500 focus:ring-green-500' : 'text-protocol-blue focus:ring-protocol-blue'}`}
                  />
        ...
        {selectedLicense && (
          <div className="bg-creator-background p-3 rounded-md mb-6 border border-gray-700">
            <p className="text-sm text-creator-text-secondary">{getSelectedLicenseExplanation()}</p>
          </div>
        )}
